...
fg_image = Image.open("C:/Users/tman/VS Code Projects/CSE110/example_images/cat_small.jpg")
fg_pixels = fg_image.load()
bg_image = Image.open("C:/Users/tman/VS Code Projects/CSE110/example_images/earth.jpg")
...
if inp == "paste":
     ...
     bg_image.save("C:/Users/tman/VS Code Projects/CSE110/example_images/bg_and_fg_paste.jpg")
     bg_image.show()
elif inp == "blend":
     for row in range(bg_h):
          for col in range(bg_w):
     ...
     bg_image.save("C:/Users/tman/VS Code Projects/CSE110/example_images/bg_and_fg_blend.jpg")
     bg_image.show()
else:
